...
## Available Scriptsnpm run dev

```

- `npm run dev` - Start development server

- `npm run build` - Build for production**Edit a file directly in GitHub**

- `npm run build:dev` - Build in development mode

- `npm run preview` - Preview production build- Navigate to the desired file(s).

- `npm run lint` - Run ESLint- Click the "Edit" button (pencil icon) at the top right of the file view.

- `npm run test` - Run tests- Make your changes and commit the changes.
...
├── components/     # React components- Click on "New codespace" to launch a new Codespace environment.

├── pages/          # Page components- Edit files directly within the Codespace and commit and push your changes once you're done.

├── hooks/          # Custom React hooks

├── lib/            # Utility functions## What technologies are used for this project?
...
Contributions are welcome! Please feel free to submit a Pull Request.- React

- shadcn-ui

## License- Tailwind CSS



This project is part of SPARKS organization.## How can I deploy this project?
